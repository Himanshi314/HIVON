  ...
  return (
    <div className="min-h-[calc(100vh-4rem)] flex items-center justify-center px-4 animate-fade-in">
      <div className="w-full max-w-sm">
        ...
        <Suspense fallback={<div className="bg-card border border-border rounded-2xl p-6 shadow-sm h-[400px] flex items-center justify-center text-muted-foreground">Loading...</div>}>
          <LoginForm />
        </Suspense>
